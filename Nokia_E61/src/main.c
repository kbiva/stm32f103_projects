...
int main (void) {
  ...
  MC2PA8201_SetRGBSET_params(sizeof(RGB12bit),RGB12bit,sizeof(RGB16bit),RGB16bit,sizeof(RGB18bit),RGB18bit);
  MC2PA8201_ColorMode(COLOR_24BIT);
